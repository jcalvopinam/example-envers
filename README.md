...
To view the deep wiki for this project, [click here](https://deepwiki.com/jcalvopinam/example-envers)
...
- Gradle `8.14` e.g. you can use the embedded wrapper `gradlew` or install `sdk install gradle 8.14`
- Docker `26.x`
...
- The application will be available at `http://localhost:8080`. You can interact with the entities and observe how
  Envers audits the changes.
...
Or if you prefer, you can look at the Controllers inside of `com.jcalvopinam.web` package and the DTOs inside of
`com.jcalvopinam.dto`
